...
class RecentProductsTwo extends Component {
    render() {
        return (
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-6 col-md-8 text-center">
                            ...
                            <p className="mb-40">Do commanded an shameless we disposing do. Indulgence ten remarkably
                                nor are impression out.</p>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                        <div className="col-xl-9 text-center mb-10">
                            <div className="btn-group product-filter-buttons-2">
                                <button className="btn active" data-filter="*">All items</button>
                                <button className="btn" data-filter=".computer">Computer</button>
                                <button className="btn" data-filter=".laptop">Laptop</button>
                                <button className="btn" data-filter=".mobile">Mobile</button>
                                <button className="btn" data-filter=".screen-pro">Screen protector</button>
                            </div>
                        </div>
                    </div>
                    <div className="row jsFilter">
                        <div className="col-lg-4 col-md-6 computer">
                            <div className="card computer border-0 product-item mt-30">
                        ...
                        <div className="col-lg-4 col-md-6 laptop">
                            <div className="card laptop border-0 product-item mt-30">
                        ...
                        <div className="col-lg-4 col-md-6 mobile computer">
                            <div className="card mobile border-0 product-item mt-30">
                        ...
                        <div className="col-lg-4 col-md-6 screen-pro">
                            <div className="card screen-pro border-0 product-item mt-30">
                        ...
                        <div className="col-lg-4 col-md-6 laptop screen-pro">
                            <div className="card computer border-0 product-item mt-30">
                        ...
                        <div className="col-lg-4 col-md-6 mobile">
                            <div className="card mobile border-0 product-item mt-30">
...
export default RecentProductsTwo;